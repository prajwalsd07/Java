...
public class JdbcApp {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * ); ps1.setInt(1, 210); ps1.setString(2, "biden"); ps1.setString(3, "joe");
		 * ps1.setString(4, "joe@gmail.com"); int n = ps1.executeUpdate(); // returns
		 * int System.out.println(n + " rows saved");
		 */
		ps.close();
		//ps1.close();
		st.close();
